...
# Get the dataframe/dataset indices for ensemble, SLC and MLC configurations
...
# encode meka and weka commands into an extended individual
    ...
    if 'meta' in algorithm:
        ...
        for key, values in config_algorithm.items():
            ...
            if key == '-W': 
                ...
                # set as 1 index of the individual referring to the algorithm
                index_individual = dict_indexes.get(algorithm)
                individual[index_individual] = 0 # 1
    ...
    if is_pt == True:
        ...
        if 'meta' in algorithm or 'LWL' in algorithm:
            ...
            for key, values in config_algorithm.items():
                ...
                if key == '-W': 
                    ...
                    # set as 1 the index of the individual referring to the SLC algorithm 
                    index_individual = dict_indexes.get(algorithm)
                    individual[index_individual] = 0 # 1
        ...
        for key, values in config_algorithm.items():
            if key == '-normalize':
                ...
                # set as 1 the index of the individual referring to the kernel
