...
class CommandMW:
    ...
    def get_commands(config, individual):
        ...
        if 'meta' in algorithm:
            ...
            i, is_normalize, command, algorithm = CommandMW.command_aux(individual, config_algorithm, i)
        ...
        if is_pt == True:
            ...
            # SLC
            i, is_normalize, command = CommandMW.command_slc_aux(individual, config, config_algorithm, i)
    ...
    def get_lenght_individual(config, individual):
        ...
        if 'meta' in algorithm:
            ...
            i, algorithm = CommandMW.get_lenght_aux(individual, config_algorithm, i)
            config_algorithm = config_algorithm['-W'][algorithm]
        ...
        if is_pt == True:
            ...
            # SLC
            i = CommandMW.get_lenght_slc_aux(individual, config, config_algorithm, i)
